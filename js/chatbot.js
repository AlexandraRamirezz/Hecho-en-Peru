document.addEventListener("DOMContentLoaded", function() {
    ...
    function showRelatedQuestions(selectedQuestion) {
      ...
      for (var i = 0; i < relatedQuestions.length; i++) {
        ...
        relatedQuestionButton.style.fontFamily = "Time New Roman"; // Cambia la tipografía aquí
        relatedQuestionButton.style.fontSize = "1rem";
        relatedQuestionButton.style.width = "97%";
        relatedQuestionButton.style.textAlign = "center";
        relatedQuestionButton.style.backgroundColor = "#393938";
        relatedQuestionButton.style.color = "white";
    ...
    function addMessage(message, sender) {
      ...
      messageContainer.style.fontFamily = "Time New Roman"; // Cambia la tipografía aquí
      messageContainer.style.fontSize = "1rem";
      messageContainer.style.textAlign = "center";
      chatLog.appendChild(messageContainer);
      chatLog.scrollTop = chatLog.scrollHeight;
      if (sender === "bot") {
        messageContainer.style.backgroundColor = "white"; // Cambia el color de fondo aquí
        messageContainer.style.width = "100%"; // Cambia tamaño de fondo aquí
        messageContainer.style.borderRadius = "8px"; // Cambiar el borde aquí
      }
    }  

...
function validatePassword() {
  ...
  if (
    !regexLongitud.test(password) ||
    !regexMinuscula.test(password) ||
    !regexMayuscula.test(password) ||
    !regexDigito.test(password)
  ) {
    passwordError.style.color = "red";
    passwordError.innerHTML =
      "La contraseña debe tener al menos 8 caracteres, una letra minúscula, una letra mayúscula y un dígito";
    inputElement.classList.remove("valid");
    inputElement.classList.add("invalid");
    return false;
  }
